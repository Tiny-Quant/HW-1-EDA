...
data_clean_cluster_1 <- cbind(data_imputed_numeric,
                              data_imputed_factor,
                              "impStatus" = data_quant_clean_imputed$impStatus,
                              "Cluster" = data_clusters$Best.partition)
```
...
data_clean_cluster_2 <- cbind(data_imputed_numeric_all,
                              data_imputed_factor,
                              "impStatus" = data_clean_imputed_all$impStatus,
                              "Cluster" = data_clusters_2$Best.partition)
```
